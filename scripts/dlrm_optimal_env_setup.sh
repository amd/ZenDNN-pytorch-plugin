...
export TORCHINDUCTOR_CPP_DYNAMIC_THREADS=1
echo "TORCHINDUCTOR_CPP_DYNAMIC_THREADS = $TORCHINDUCTOR_CPP_DYNAMIC_THREADS"

export TORCHINDUCTOR_CPP_WRAPPER=1
echo "TORCHINDUCTOR_CPP_WRAPPER = $TORCHINDUCTOR_CPP_WRAPPER"

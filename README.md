...
__The pre-release for ZenDNN Plugin for PyTorch* (zentorch) [2.12.0.2]__
...
```
>**Notes:**
>* The repository defaults to the main branch. To build the rc3 for 2.12.0.2, checkout the tag v2.12.0.2_rc3: ```git checkout v2.12.0.2_rc3```

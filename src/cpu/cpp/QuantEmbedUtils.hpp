...
quant_eb_tensors_to_memory(
    ...
    const at::Tensor &offsets,
    const c10::optional<at::Tensor> &per_sample_weights_opt,
    const int64_t &mode, memory &z_weight, memory &z_indices, memory &z_offsets,
    memory &z_per_sample_weights_opt, algorithm &z_algorithm,
    bool include_last_offset, const int64_t &num_bits_per_weight,

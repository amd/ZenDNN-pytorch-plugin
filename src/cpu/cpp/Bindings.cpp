...
TORCH_LIBRARY(zentorch, m) {
  ...
  m.def("zentorch_mm(Tensor self, Tensor mat2, *) -> Tensor");
  m.def("zentorch_mm_relu(Tensor self, Tensor mat2, *) -> Tensor");
  m.def("zentorch_mm_gelu_tanh(Tensor self, Tensor mat2, *) -> Tensor");
  m.def("zentorch_mm_gelu_erf(Tensor self, Tensor mat2, *) -> Tensor");
  m.def("zentorch_bmm(Tensor self, Tensor mat2) -> Tensor");
  m.def(
  ...
  m.def("zentorch_attn_horizontal_mlp_group(Tensor[] self, Tensor[] inputs, "
        "Tensor[] weights, "
        "float[] betas, float[] alphas, int[] fuse, int[] is_zentorch_mm) -> "
        "Tensor[]");
  m.def(

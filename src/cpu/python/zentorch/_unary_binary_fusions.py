        ...
        def create_replacement_fn_unary_binary(
            ...
            if has_bias:
                    ...
                    *,
                    ...
                    def repl(
                        ...
                        if unary_name == "none":
                            ...
                            counters["zentorch"][
                                "zentorch_linear_" + new_unary_name + "_" + binary_name
                            ] += 1
                ...
                replacement_fn.__name__ = (
                    f"zentorch_linear_{unary_name}_{binary_name}_replacement_{idx}"
                )
...
def zentorch_unary_binary_post_op_fusions(fx_graph: Graph) -> Graph:
    # register the patterns
    register_unary_binary_fusions()  # type: ignore[arg-type]
    GraphTransformObserver = functools.partial(
        torch.fx.passes.graph_transform_observer.GraphTransformObserver,
        subsystem="zentorch_unary_binary_post_op_fusions",
    )

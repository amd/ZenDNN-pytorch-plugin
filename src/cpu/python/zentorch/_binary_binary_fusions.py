...
from ._unary_binary_fusions import (
    binary_post_op_dict,
    calc_strides,
    same_dtypes_check,
)
from ._unary_fusions import create_linear_compute_fn
                ...
                def replacement_fn(
                    ...
                    *,
                    ...
                    def repl(
                        ...
                        counters["zentorch"][
                            "zentorch_linear_" + binary_name_1 + "_" + binary_name_2
                        ] += 1
                        if idx == 0:
                            return zentorch.zentorch_linear_binary_binary(
                                arg_0,
                                arg_1,
                                arg_3,
                                arg_4,
                                ...
                                zentorch_op_name=zentorch_op_name + "_" + binary_name_1 + "_" + binary_name_2,
                            )
                        elif idx == 1:
                            return zentorch.zentorch_linear_binary_binary(
                                arg_1,
                    ...
                    match.replace_by_example(
                        repl, [arg_0, arg_1, arg_2, arg_3, arg_4, is_weight_prepacked, zentorch_op_name]
                    )
...
def zentorch_binary_binary_post_op_fusions(fx_graph: Graph) -> Graph:
    # register the patterns
    register_binary_binary_fusions()  # type: ignore[arg-type]
    GraphTransformObserver = functools.partial(
        torch.fx.passes.graph_transform_observer.GraphTransformObserver,
        subsystem="zentorch_binary_binary_post_op_fusions",
    )

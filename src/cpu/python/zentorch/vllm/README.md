...
|-----------|---------|-------|
| vLLM | 0.15.0 - 0.19.0 | V1 engine fully supported |
| Python | 3.10+ | |
...
2. **Build vLLM from Source:**
   ...
   - Supported versions: 0.15.0, 0.15.1, 0.16.0, 0.17.0, 0.17.1, 0.18.0, 0.18.1, 0.19.0. Check out the appropriate release tag before building.

3. **Install zentorch:**

   | vLLM version | PyTorch version (auto-installed by vLLM) | zentorch install method |
   |--------------|-----------------|------------------------|
   | 0.15.0 - 0.19.0 | 2.10.0 | PyPI or source |
...
2. Check vLLM version: `python -c "import vllm; print(vllm.__version__)"` (must be 0.15.0 - 0.19.0)

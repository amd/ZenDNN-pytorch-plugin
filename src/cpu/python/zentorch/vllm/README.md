...
|-----------|---------|-------|
| vLLM | 0.15.0 - 0.20.2 | V1 engine fully supported |
| Python | 3.10+ | |
| PyTorch | 2.10.0 (vLLM 0.15.0-0.19.x) / 2.11.0 (vLLM 0.20.0-0.20.2) | Auto-installed by vLLM |
| TorchAO | 0.16.0 (vLLM 0.15.0-0.19.x) / 0.17.0 (vLLM 0.20.0-0.20.2) | |
...
2. **Build vLLM from Source:**
   ...
   - Supported versions: 0.15.0, 0.15.1, 0.16.0, 0.17.0, 0.17.1, 0.18.0, 0.18.1, 0.19.0, 0.19.1, 0.20.0, 0.20.1, 0.20.2. Check out the appropriate release tag before building.
...
3. **Install zentorch:**
   ...
   | 0.20.0 - 0.20.2 | 2.11.0 | PyPI or source |
...
2. Check vLLM version: `python -c "import vllm; print(vllm.__version__)"` (must be 0.15.0 - 0.20.2)

__The latest ZenDNN Plugin for PyTorch* (zentorch) 5.2.0 pre-release is here!__
...
The zentorch 5.2.0 pre-release plugs seamlessly with PyTorch versions from 2.10.0 and 2.9.1, offering a high-performance experience for deep learning on AMD EPYC™ platforms.

...
#  *
#  * Was sourced from
#  * https://github.com/mlcommons/inference_results_v3.1/blob/main/closed/Intel/code/dlrm-v2-99/pytorch-cpu-int8/tools/accuracy-dlrm.py  # noqa: B950
#  * commit ID: eaf622a
#  ******************************************************************************
"""
Tool to calculate accuracy for loadgen accuracy output found in
mlperf_log_accuracy.json We assume that loadgen's query index is in the same
order as samples in the last 24th day of the pre-processed data set.
"""
...
def get_args():
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "path to day_23 file. If present, it is assumed that the accuracy "
            "log contains only the prediction, not the ground truth label."
        ),
    )
    parser.add_argument(
        ...
        default=None,
        help=(
            "path to dlrm_trace_of_aggregated_samples.txt. Only needed if"

...
set(FLAGS "-Wall -Werror -Wno-unknown-pragmas -Wno-error=uninitialized \
          ...
          -mavx512f -mavx512bf16 -mavx512vl -DCPU_CAPABILITY_AVX512")

set_source_files_properties(${mha_512} PROPERTIES COMPILE_FLAGS "${FLAGS}")

# creating library for mha
add_library(CPUkernels STATIC ${mha_512})
